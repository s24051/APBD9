...
namespace EF.CodeFirst.Migrations
{
    ...
    [Migration("20240618221124_ChangeConfigs")]
            ...
            modelBuilder.Entity("EF.CodeFirst.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(2024, 6, 19, 0, 11, 22, 321, DateTimeKind.Local).AddTicks(9078),
                            FirstName = "Adrian",
                            LastName = "Adrianski"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2024, 5, 6, 0, 11, 22, 327, DateTimeKind.Local).AddTicks(3237),
                            FirstName = "Jacek",
                            LastName = "Jackowski"
                        });
                });
            ...
            modelBuilder.Entity("EF.CodeFirst.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2024, 6, 25, 0, 11, 22, 336, DateTimeKind.Local).AddTicks(7621),
                            DueDate = new DateTime(2024, 7, 19, 0, 11, 22, 336, DateTimeKind.Local).AddTicks(8105),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2024, 7, 1, 0, 11, 22, 336, DateTimeKind.Local).AddTicks(8532),
                            DueDate = new DateTime(2024, 4, 20, 0, 11, 22, 336, DateTimeKind.Local).AddTicks(8544),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
